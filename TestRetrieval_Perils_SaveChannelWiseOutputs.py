...
EEG_DATASET_PATH = "./data/eeg/theperils/spampinato-1-IMAGE_BLOCK_14Hz_71Hz.pth"
...
timespan, channels = eeg.shape 

listofchannels = []
for i in range(channels):
    # listofchannels.append(i)
    Utilities_handler.plotSampleEEGChannels(eeg_data=[eeg], channels_to_plot=[i], saveFigure=True, saveFigurename=f"output/ch_{i}_the_perils.png")
